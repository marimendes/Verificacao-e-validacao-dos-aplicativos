...
```
Funcionalidade: Botão de alto constraste.

Cenário ocorre quando o usuário deseja ativar o alto contraste no aplicativo,
mas nada acontece.

DADO que o usuário esteja na tela de login
E clique no botão "Alto Contraste"
ENTÃO nada acontece no aplicativo.
